...
Install the pinned VSIX from the [v0.19.10 release](https://github.com/ChaosLights/vscode-leetcode/releases/tag/v0.19.10) in a local VS Code window, not in the Codespace extension host.
