...
1. 主机和所有来宾都从 [v0.19.13 Release](https://github.com/ChaosLights/vscode-leetcode/releases/tag/v0.19.13) 下载并在各自桌面版 VS Code 本地安装同一个 `vscode-leetcode-live-share-0.19.13.vsix`，不要把它安装到 Codespace 容器。
