...
3. Run `npm run lint`, `npm test`, and `npm run test:vscode`. The VS Code integration suite must pass the host/remoted-guest CodeLens, local-command bridge, virtual-workspace create, propagation, no-overwrite, symlink, and read-only cases.
