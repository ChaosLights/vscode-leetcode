...
- [English Document](../README.md#requirements) | 中文文档
...
- 桌面版 [VS Code 1.100.0+](https://code.visualstudio.com/)、已验证的 Live Share 1.1.122，以及本机 `PATH` 中可执行的外部 [Node.js 20+](https://nodejs.org/)。
